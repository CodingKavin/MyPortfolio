          ...
          <div className="about-me__about">
            <div className="about-me__about-content">
              <Typography variant="p1" className="about-me__description">
                ...
                how things work under the hood, whether it is complex sci-fi
                lore or a JWT validation flow. I specialize in building clean,
                functional applications like my recent full-stack budget
                tracker, and I am currently deep-diving into the Java, Spring
                Boot, and AWS ecosystem. When I'm not at my terminal, I'm
                usually gaming, watching anime, or heading to the mountains for
                some snowboarding and hiking. I am a direct communicator who
                values efficiency, clear documentation, and getting the job done
                right.
              </Typography>
              <Button
                variant="primary"
